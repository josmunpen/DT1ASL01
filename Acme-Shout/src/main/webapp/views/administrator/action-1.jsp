...
<table>
	...
	<tr>
		...
		<td><jstl:out value="${statictics.get('count.all.shouts')}" /></td>
	</tr>
	<tr>
		<td><spring:message code="administrator.count.short.shouts" /><td>
		<td><jstl:out value="${statictics.get('count.short.shouts')}" /></td>
	</tr>
	<tr>
		<td><spring:message code="administrator.count.long.shouts" /><td>
		<td><jstl:out value="${statictics.get('count.long.shouts')}" /></td>
	</tr>
</table>
